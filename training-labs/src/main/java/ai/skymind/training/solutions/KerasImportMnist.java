...
public class KerasImportMnist {
    public static void main(String[] args) throws Exception{
        ...
        String kerasModelfromKerasExport = new ClassPathResource("Keras/mnist_mlp.h5").getFile().getPath();
       ...
       // MultiLayerNetwork model = org.deeplearning4j.nn.modelimport.keras.KerasModelImport.importKerasSequentialModelAndWeights(kerasModelfromKerasExport);
        ...
        INDArray image = Nd4j.readNumpy("/Users/tomhanlon/SkyMind/java/Keras_Workshop/training-parent/training-labs/src/main/resources/Keras/image-5.npy");
